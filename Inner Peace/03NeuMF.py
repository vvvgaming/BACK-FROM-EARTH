...
def parse_args():
	...
	parser.add_argument('--layers', nargs = '?', default = '[64, 32, 16, 8]', help = 'MLP layers. Note that the first layer is the concatenation of user and item embeddings. So layer')
